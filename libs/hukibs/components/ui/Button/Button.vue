...
.button {
  ...
  &__container {
    ...
    gap: var(--button-container-gap, var(--space-s));
  ...
  &--large {
    .button__container {
      padding: var(--button-container-padding, var(--space) var(--space-l));
      font-size: 1.125rem;
    }
  }
  ...
  &--icon-only {
    .button__container {
      padding: var(--button-container-padding, var(--space-s));
      aspect-ratio: 1;
    }
