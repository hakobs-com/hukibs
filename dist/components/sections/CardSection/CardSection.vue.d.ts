import { CardSectionProps } from './CardSection.model';

declare function __VLS_template(): {
    footer?(_: {}): any;
};
declare const __VLS_component: import('vue').DefineComponent<import('vue').ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<CardSectionProps>, {
    padding: string;
