import { AppHeaderProps } from './AppHeader.model';

declare function __VLS_template(): {
    logo?(_: {}): any;
    "nav-link"?(_: {
        item: import('./AppHeader.model').AppHeaderNavItem;
    }): any;
    actions?(_: {}): any;
    "extra-actions"?(_: {}): any;
};
declare const __VLS_component: import('vue').DefineComponent<import('vue').ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<AppHeaderProps>, {
    ...
    "settings-click": () => void;
}, string, import('vue').PublicProps, Readonly<import('vue').ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<AppHeaderProps>, {
    showThemeToggle: boolean;
    showSettings: boolean;
}>>> & Readonly<{
