import { TabProps } from './Tabs.model';

declare const _default: import('vue').DefineComponent<import('vue').ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<TabProps>, {
    disabled: boolean;
